function GameManager(size, InputManager, Actuator) {
    ...
    this.inputManager.on("closeNotice", this.closeNotice.bind(this));
}

GameManager.prototype.closeNotice = function () {
    var notice;
    if((notice = document.querySelector(".app-notice")) != null) {
...
GameManager.prototype.actuate = function () {
    ...
    if (this.over) {
        $(".game-container").before(notice1 + "Game Lost :(" + notice2);
    }
...
GameManager.prototype.move = function (direction, randoms) {
    //console.log(JSON.stringify(this.grid.serialize()));
